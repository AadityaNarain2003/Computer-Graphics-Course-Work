...
struct Scene {
    ...
    void intersectBVH2(uint32_t nodeIdx, Ray &ray, Interaction& si, float maxDistance,Vector3f &point,Vector3f &light);
    Interaction rayIntersect2(Ray& ray, float maxDistance,Vector3f &point,Vector3f &light);
};